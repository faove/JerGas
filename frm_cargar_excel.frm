...
Private Sub cmd_crear_Click()
    ...
    resumen_pedidos.RecordSource = "select * from resumen_pedidos WHERE (fecha_cancel >='" & fecha_desde.Value & "') AND (fecha_cancel <='" & fecha_hasta.Value & "')"
